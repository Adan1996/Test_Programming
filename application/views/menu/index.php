...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-primary mb-3 add-menu" data-toggle="modal" data-target="#MenuModal">Add New Menu</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="<?= base_url('menu/edit/') . $m['id']; ?>" class="badge badge-success edit-menu" data-toggle="modal" data-target="#MenuModal" data-id="<?= $m['id']; ?>">edit</a>
